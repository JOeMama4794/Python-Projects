...
def main():
    ...
    while True:
        ...
        #Moving the CPU
        if ball.positiony < cpu.positiony and cpu.positiony > 0:
            cpu.positiony -= move_speed + 3
        if ball.positiony > cpu.positiony and cpu.positiony < 860:
            cpu.positiony += move_speed - 2
